...
return [
    ...
    'import' => [
        ...
        'import_result' => 'Importováno :úspěch :total vajec',
        'imported_eggs' => 'Importováno: :eggs',
        'failed_import_eggs' => 'Nezdařilo se: :eggs',
        'github' => 'Přidat z Githubu',
        'refresh' => 'Obnovit',
        'import_image' => 'Importovat obrázek',
        'delete_image' => 'Smazat image',
...
Povolení této volby zakáže interní síťové připojení pro všechny servery používající tento egg, což způsobí, že nemohou interně přistupovat k jiným serverům ve stejném uzlu.',
    ...
    'update_success' => ':egg úspěšně aktualizováno',
    'update_failed' => 'Aktualizace :egg se nezdařila',
    ...
    'cannot_update' => 'Nelze aktualizovat :count vajec',
    'no_update_url' => 'Následující vejce nemají nastavenou funkční aktualizační URL: :eggs',
    'cannot_delete' => 'Nelze odstranit :count vajec',
    'eggs_have_servers' => 'Následující vejce mají servery a nemohou být odstraněny: :eggs',
    'updated_from' => 'Úspěšně aktualizováno z: :url',
    'update_error' => 'Chyba: :error',
    'updated_eggs' => 'Aktualizováno: :eggs',
    'failed_eggs' => 'Chyba: :eggs',
    'skipped_eggs' => 'Přeskočeno: :eggs',
];
